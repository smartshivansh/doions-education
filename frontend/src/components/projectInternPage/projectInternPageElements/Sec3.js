  ...
  return (
    <div className={classes.container}>
      ...
      <p className={classes.content}>
        ...
        have an interest and motivation to create a carrer out of their passion.
      ...
      <ul>
        ...
        <li className={classes.listitem}>
          You'll get all-round learning experience of working with a
          product-based start-up. Learn about latest technologies, develops
          softskills, personality development etc. and stand out among your
          peers and friends
        </li>
        <li className={classes.listitem}>
